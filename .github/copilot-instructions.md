...
### Project Summary
- **Purpose**: Cross-platform Minecraft launcher with instance management, mod/resource pack management, and multi-account support
...
- **Core Modules**:
  ...
  - `resource`: CurseForge/Modrinth integration for downloading mods/modpacks
