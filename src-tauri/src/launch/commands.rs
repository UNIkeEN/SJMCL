use super::helpers::command_generator::{
  export_full_launch_command, generate_launch_command, split_wrapper, LaunchCommand,
};
...
pub async fn launch_game(
  ...
  let precall = game_config.advanced.custom_commands.precall_command.clone();
  if !precall.trim().is_empty() {
    #[cfg(target_os = "windows")]
