...
const LAUNCHER_CFG_FILE_NAME: &str = "sjmcl.conf.json";
const CONFIG_PARTIAL_UPDATE_EVENT: &str = "config:partial-update";
  ...
  pub struct LauncherConfig {
    ...
    pub general: struct GeneralConfig {
      ...
      pub functionality: struct {
        ...
        #[default = true]
        pub translated_filename_prefix: bool,
        #[default = true]
    ...
    pub extension: struct ExtensionConfig {
      ...
      #[serde(default)]
      pub home_widget_state: Vec<(String, u32, bool)>,
    },
